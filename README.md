...
![Data Model](2b-egypt-retail-analytics/Images/1.png)

### 2. Executive Overview Dashboard (Power BI)
![Executive Overview](2b-egypt-retail-analytics/Images/2.jpg)

### 3. Product & Returns Performance Dashboard (Power BI)
![Product Performance](2b-egypt-retail-analytics/Images/3.jpg)

### 4. Target Audience & Employee KPI Dashboard (Power BI)
![Target Audience](2b-egypt-retail-analytics/Images/4.jpg)

### 5. Excel Deep-Dive - Executive Summary (Pivot Tables)
![Excel Summary 1](2b-egypt-retail-analytics/Images/5.png)

### 6. Excel Deep-Dive - Returns Analysis
![Excel Summary 2](2b-egypt-retail-analytics/Images/6.png)

### 7. Excel Deep-Dive - Product Performance
![Excel Summary 3](2b-egypt-retail-analytics/Images/7.png)

### 8. Excel Deep-Dive - Employee KPI
![Excel Summary 4](2b-egypt-retail-analytics/Images/8.png)
